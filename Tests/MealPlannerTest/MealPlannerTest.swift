...
class MealPlannerTest: XCTestCase {
    ...
    func testCalculateDailyCalories() {
        ...
        let expectedCalories = 2228 // Replace with the actual calculation if needed
    ...
    func testHealthTip() {
        ...
        // Expected health tip
        let expectedTip = "You are obese. Consider professional help for a tailored health plan."
    ...
    func testSuggestFoods() {
        ...
        XCTAssertFalse(
            suggestedFoods.contains { food in food.name == "Chicken Breast" },
