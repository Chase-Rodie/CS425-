...
//                    fatalError(
//                        "Unable to generate random nonce. SecRandomCopyBytes failed with OSStatus \(errorCode)")
//                }
//                return random
//            }
//            
...
//}
//
////Generic so should be able to be used in any application that has Apple Sign In
